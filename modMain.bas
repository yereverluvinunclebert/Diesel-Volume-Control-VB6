...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    ' = "none"
    gblStartupFlg = True
    gblWidgetName = "Diesel Volume Control"
    ...
    menuForm.mnuAbout.Caption = "About Diesel Volume Control Cairo " & gblCodingEnvironment & " widget"
...
'        gblVolumeBoost = fGetINISetting(Location, "volumeBoost", gblSettingsFile)
        ...
        ' other
        gblGaugeHighDpiXPos = fGetINISetting("Software\DieselVolumeControl", "gaugeHighDpiXPos", gblSettingsFile)
        gblGaugeHighDpiYPos = fGetINISetting("Software\DieselVolumeControl", "gaugeHighDpiYPos", gblSettingsFile)
        gblGaugeLowDpiXPos = fGetINISetting("Software\DieselVolumeControl", "gaugeLowDpiXPos", gblSettingsFile)
        gblGaugeLowDpiYPos = fGetINISetting("Software\DieselVolumeControl", "gaugeLowDpiYPos", gblSettingsFile)
