   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":288C
            Left            =   1530
            List            =   "frmPrefs.frx":288E
            Style           =   2  'Dropdown List
            TabIndex        =   53
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\DieselVolumeControl", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Diesel-Volume-Control-VB6\Diesel-Volume-Control-VB6.vbp"
...
'    End If
    ...
    If gblStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "VolumeControlWidget", """" & App.path & "\" & "Diesel Volume Control.exe""")
    Else
    ...
    If fFExists(gblSettingsFile) Then
        sPutINISetting "Software\DieselVolumeControl", "enableTooltips", gblEnableTooltips, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "enableBalloonTooltips", gblEnableBalloonTooltips, gblSettingsFile
        ...
        sPutINISetting "Software\DieselVolumeControl", "clockFont", gblClockFont, gblSettingsFile
        ...
        sPutINISetting "Software\DieselVolumeControl", "defaultEditor", gblDefaultEditor, gblSettingsFile
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Diesel Volume Control VB6", vbNullString, App.path, 1)
    End If
