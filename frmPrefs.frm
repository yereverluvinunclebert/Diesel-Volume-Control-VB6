...
'    End If
    ...
    If gblStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "DieselVolumeControl", """" & App.path & "\" & "Diesel Volume Control.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "DieselVolumeControl", vbNullString)
    End If
...
Private Sub adjustPrefsControls()
    ...
    txtDefaultEditor.Text = gblDefaultEditor
    lblGitHub.Caption = "You can find the code for the Dieselpunk Volume Control on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/ Dieselpunk-Volume-Control-VB6"
