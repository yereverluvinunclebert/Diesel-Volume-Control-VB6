...
Private Sub optGaugeTooltips_Click(Index As Integer)
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\DieselVolumeControl", "gaugeTooltips", gblGaugeTooltips, gblSettingsFile
...
Private Sub optPrefsTooltips_Click(Index As Integer)
   ...
   On Error GoTo optPrefsTooltips_Click_Error
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\DieselVolumeControl", "prefsTooltips", gblPrefsTooltips, gblSettingsFile
   ...
   On Error GoTo cmbMultiMonitorResize_Click_Error
    ...
    If cmbMultiMonitorResize.ListIndex = 2 Then
        If prefsMonitorStruct.IsPrimary = True Then
            ...
            sPutINISetting "Software\DieselVolumeControl", "gaugePrimaryHeightRatio", gblGaugePrimaryHeightRatio, gblSettingsFile
            
            'gblPrefsPrimaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\DieselVolumeControl", "prefsPrimaryHeightTwips", gblPrefsPrimaryHeightTwips, gblSettingsFile
        Else
            gblGaugeSecondaryHeightRatio = fVolume.volumeForm.WidgetRoot.Zoom
            sPutINISetting "Software\DieselVolumeControl", "gaugeSecondaryHeightRatio", gblGaugeSecondaryHeightRatio, gblSettingsFile
            
            'gblPrefsSecondaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\DieselVolumeControl", "prefsSecondaryHeightTwips", gblPrefsSecondaryHeightTwips, gblSettingsFile
        End If
    End If
...
Private Sub Form_Load()
    ...
    Me.mnuAbout.Caption = "About Diesel Volume Control Cairo " & gblCodingEnvironment & " widget"
...
Public Sub positionPrefsMonitor()
    ...
    If gblMonitorCount > 1 And LTrim$(gblMultiMonitorResize) = "2" Then
        ...
        If prefsMonitorStruct.IsPrimary = True Then
            gblPrefsFormResizedInCode = True
            gblPrefsPrimaryHeightTwips = fGetINISetting("Software\DieselVolumeControl", "prefsPrimaryHeightTwips", gblSettingsFile)
            ...
            End If
        Else
            gblPrefsSecondaryHeightTwips = fGetINISetting("Software\DieselVolumeControl", "prefsSecondaryHeightTwips", gblSettingsFile)
            gblPrefsFormResizedInCode = True
...
Private Sub chkDpiAwareness_Click()
    ...
    If pvtPrefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\DieselVolumeControl", "dpiAwareness", gblDpiAwareness, gblSettingsFile
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Diesel-Volume-Control-VB6MkII\Diesel-Volume-Control-VB6.vbp"
...
'    End If
    ...
    If gblStartup = "1" Then
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "DieselVolumeControl", """" & App.Path & "\" & "Diesel-Volume-Control-VB6.exe""")
    Else
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "DieselVolumeControl", vbNullString)
    End If
    ...
    If fFExists(gblSettingsFile) Then
        ...
        sPutINISetting "Software\DieselVolumeControl", "showTaskbar", gblShowTaskbar, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "showHelp", gblShowHelp, gblSettingsFile
        
        sPutINISetting "Software\DieselVolumeControl", "dpiAwareness", gblDpiAwareness, gblSettingsFile
        
        
        sPutINISetting "Software\DieselVolumeControl", "gaugeSize", gblGaugeSize, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "scrollWheelDirection", gblScrollWheelDirection, gblSettingsFile
        ...
        sPutINISetting "Software\DieselVolumeControl", "widgetPortrait", gblWidgetPortrait, gblSettingsFile

        sPutINISetting "Software\DieselVolumeControl", "prefsFont", gblPrefsFont, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "gaugeFont", gblGaugeFont, gblSettingsFile
        
        sPutINISetting "Software\DieselVolumeControl", "prefsFontSizeHighDPI", gblPrefsFontSizeHighDPI, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "prefsFontSizeLowDPI", gblPrefsFontSizeLowDPI, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "prefsFontItalics", gblPrefsFontItalics, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "prefsFontColour", gblPrefsFontColour, gblSettingsFile
        
        sPutINISetting "Software\DieselVolumeControl", "displayScreenFont", gblDisplayScreenFont, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "displayScreenFontSize", gblDisplayScreenFontSize, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "displayScreenFontItalics", gblDisplayScreenFontItalics, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "displayScreenFontColour", gblDisplayScreenFontColour, gblSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\DieselVolumeControl", "windowLevel", gblWindowLevel, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "preventDragging", gblPreventDragging, gblSettingsFile
        
        sPutINISetting "Software\DieselVolumeControl", "opacity", gblOpacity, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "widgetHidden", gblWidgetHidden, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "hidingTime", gblHidingTime, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "ignoreMouse", gblIgnoreMouse, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "multiMonitorResize", gblMultiMonitorResize, gblSettingsFile
        
        
        sPutINISetting "Software\DieselVolumeControl", "startup", gblStartup, gblSettingsFile

        sPutINISetting "Software\DieselVolumeControl", "enableSounds", gblEnableSounds, gblSettingsFile
'        sPutINISetting "Software\DieselVolumeControl", "enableTicks", gblEnableTicks, gblSettingsFile
'        sPutINISetting "Software\DieselVolumeControl", "enableChimes", gblEnableChimes, gblSettingsFile
'        sPutINISetting "Software\DieselVolumeControl", "enableAlarms", gblEnableAlarms, gblSettingsFile
'        sPutINISetting "Software\DieselVolumeControl", "volumeBoost", gblVolumeBoost, gblSettingsFile
        
        sPutINISetting "Software\DieselVolumeControl", "lastSelectedTab", gblLastSelectedTab, gblSettingsFile
        
        sPutINISetting "Software\DieselVolumeControl", "debug", gblDebug, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "dblClickCommand", gblDblClickCommand, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "openFile", gblOpenFile, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "defaultVB6Editor", gblDefaultVB6Editor, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "defaultTBEditor", gblDefaultTBEditor, gblSettingsFile
        
        sPutINISetting "Software\DieselVolumeControl", "gaugeHighDpiXPos", gblGaugeHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "gaugeHighDpiYPos", gblGaugeHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\DieselVolumeControl", "gaugeLowDpiXPos", gblGaugeLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\DieselVolumeControl", "gaugeLowDpiYPos", gblGaugeLowDpiYPos, gblSettingsFile
...
'    chkVolumeBoost.Value = Val(gblVolumeBoost)
    ...
    lblGitHub.Caption = "You can find the code for the Diesel Volume Control on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/Diesel-Volume-Control"
...
Private Sub optGaugeTooltips_MouseMove(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If gblPrefsTooltips = "0" Then
        If Index = 0 Then
            thisToolTip = "This setting enables the balloon tooltips for elements within the DieselPunk GUI. These tooltips are multi-line and in general more attractive than standard windows style tooltips, note that their font size will match the Windows system font size."
            CreateToolTip optGaugeTooltips(Index).hWnd, thisToolTip, _
                  TTIconInfo, "Help on Balloon Tooltips on the GUI", , , , True
        ElseIf Index = 1 Then
            thisToolTip = "This setting enables the RichClient square tooltips for elements within the DieselPunk GUI. These tooltips are multi-line and in general more attractive than standard windows style tooltips."
            CreateToolTip optGaugeTooltips(Index).hWnd, thisToolTip, _
                  TTIconInfo, "Help on RichClient Tooltips on the GUI", , , , True
        ElseIf Index = 2 Then
            thisToolTip = "This setting disables the balloon tooltips for elements within the DieselPunk GUI."
            CreateToolTip optGaugeTooltips(Index).hWnd, thisToolTip, _
...
Private Sub chkEnableSounds_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If gblPrefsTooltips = "0" Then CreateToolTip chkEnableSounds.hWnd, "Check this box to enable or disable all of the sounds used during any animation on the main DieselPunk GUI, as well as all other chimes, tick sounds &c.", _
...
Private Sub optPrefsTooltips_MouseMove(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If gblPrefsTooltips = "0" Then
        ...
        ElseIf Index = 1 Then
            thisToolTip = "This setting enables the standard Windows-style square tooltips for elements within the DieselPunk GUI. These tooltips are single-line and the font size is limited to the Windows font size."
            CreateToolTip optPrefsTooltips(Index).hWnd, thisToolTip, _
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hWnd, "Open", "https://github.com/yereverluvinunclebert/Diesel-Volume-Control-" & gblCodingEnvironment, vbNullString, App.Path, 1)
    End If
   ...
   On Error GoTo setPrefsTooltips_Error
    ...
    ' next we just do the native VB6 tooltips
     If optPrefsTooltips(1).Value = True Then
        ...
        chkEnableSounds.ToolTipText = "Check this box to enable or disable all of the sounds used during any animation on the main DieselPunk GUI as well as all other chimes, tick sounds."
...
'    widgetPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\DieselVolumeControl", "skinTheme", gblSkinTheme, gblSettingsFile
